<template>
  <header
    class="retrato-tablet:px-5 bg-[#242424] retrato-tablet:py-5  px-3 py-4 retrato-tablet:border-r border-b w-full border-zinc-700 retrato-tablet:h-screen retrato-tablet:w-24"
  >
    <div
      class="w-full h-full items-center flex retrato-tablet:flex-col flex-row justify-between"
    >
      <div class="container_navbar_top w-full retrato-tablet:pt-3">
        <ul
      ...
      >
        ...
        <div
          class="retrato-tablet:hidden flex justify-center ring-opacity-15 items-center gap-2 bg-[#242424] text-center text-white"
        >
          <h5 class="font-semibold">100</h5>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
