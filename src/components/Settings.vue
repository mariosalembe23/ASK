    ...
    >
      <header class="flex justify-between items-center px-3">
        ...
        <button
          ...
          class="text-zinc-300 shadow-lg transition-all w-10 h-10 rounded-full flex items-center justify-center bg-zinc-800 hover:text-white"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
      ...
      <div class="grid retrato-tablet:grid-cols-2 grid-cols-1 mt-5 gap-3">
        ...
        >
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="w-6 h-6 stroke-indigo-500"
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
